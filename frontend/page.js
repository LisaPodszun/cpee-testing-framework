...
async function displayResults(data_promise, appendto) {
    ...
    jQuery.each(data['results'], function (key, value) {
        ...
        let ins_2_info_content =  $('<ul class="list-group list-group-flush"</ul>').html(`<li class="list-group-item">Process Engine: ${data['settings']['instance_2']['process_engine']}</li><li class="list-group-item">Execution Handler: ${data['settings']['instance_2']['execution_handler']}</li>`)
